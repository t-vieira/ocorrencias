...
$dbname="db_ocorrencia"; // Indique o nome do banco de dados que serﻓ aberto
...
if(!($id = mysql_connect("localhost",$usuario,$password))) {
   echo "Nﻛo foi possível estabelecer uma conexﻛo com o gerenciador MySQL. Favor Contactar o Administrador.";
   exit;
}
//2ﻑ passo - Seleciona o Banco de Dados
if(!($con=mysql_select_db($dbname,$id))) {
   echo "Não foi possível estabelecer uma conexﻛo com o gerenciador MySQL. Favor Contactar o Administrador.";
   exit;
}
